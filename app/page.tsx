...
export default function Home() {
  return (
    <main className="relative flex-1 overflow-hidden bg-zinc-950 text-zinc-50">
      ...
      <div className="pointer-events-none absolute left-0 top-20 h-72 w-72 rounded-full bg-yellow-400/10 blur-3xl" />
      <div className="pointer-events-none absolute bottom-0 right-0 h-80 w-80 rounded-full bg-yellow-300/5 blur-3xl" />

      <section className="relative mx-auto grid w-full max-w-7xl gap-10 px-4 py-16 sm:px-6 lg:grid-cols-[1.05fr_0.95fr] lg:px-8 lg:py-24">
        <motion.div
        ...
        >
          ...
          <div className="max-w-3xl space-y-6">
            <h1 className="max-w-4xl bg-gradient-to-b from-zinc-50 via-zinc-200 to-zinc-600 bg-clip-text text-5xl font-semibold leading-[0.92] tracking-tight text-transparent text-balance sm:text-6xl lg:text-7xl">
              {heroTitle}
            </h1>
          ...
          <div className="flex flex-wrap gap-4">
            ...
            <a
              href="/portafolio"
              className="inline-flex items-center justify-center gap-2 rounded-full border border-white/10 bg-white/5 px-6 py-3 text-sm font-semibold text-zinc-100 transition hover:border-yellow-400/40 hover:bg-white/10 hover:text-yellow-300"
            >
              Cotiza tu Proyecto
        ...
        <motion.div
          ...
          className="relative self-start lg:pt-4"
        >
          ...
          <div className="relative overflow-hidden rounded-[2rem] border border-white/10 bg-white/[0.04] shadow-2xl shadow-black/30 backdrop-blur-xl">
            ...
            />
            <div className="absolute inset-x-5 bottom-5 rounded-2xl border border-white/10 bg-zinc-950/75 p-5 backdrop-blur-xl">
              <p className="text-xs uppercase tracking-[0.35em] text-yellow-300">Problema / Solución</p>
              <p className="mt-3 text-sm leading-7 text-zinc-300">{problemSolution}</p>
            </div>
          </div>
        </motion.div>
      </section>
